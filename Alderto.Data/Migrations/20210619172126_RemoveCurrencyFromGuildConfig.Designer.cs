...
namespace Alderto.Data.Migrations
{
    ...
    [Migration("20210619172126_RemoveCurrencyFromGuildConfig")]
    partial class RemoveCurrencyFromGuildConfig
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alderto.Data.Models.CurrencyTransaction", b =>
                {
                    ...
                    b.HasIndex("GuildId", "RecipientId");

                    b.HasIndex("GuildId", "SenderId");
            ...
            modelBuilder.Entity("Alderto.Data.Models.CurrencyTransaction", b =>
                {
                    b.HasOne("Alderto.Data.Models.GuildMember", "Recipient")
                        .WithMany()
                        .HasForeignKey("GuildId", "RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alderto.Data.Models.GuildMember", "Sender")
                        .WithMany()
                        .HasForeignKey("GuildId", "SenderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
