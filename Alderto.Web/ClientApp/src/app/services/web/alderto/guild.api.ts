...
import { IGuildChannel, IGuildRole, GuildConfiguration } from 'src/app/models';
...
export class AldertoWebGuildApi {
  ...
  public fetchPreferences(id: string) {
    return this.http.get<GuildConfiguration>(`/api/guilds/${id}/preferences`);
  }
}
