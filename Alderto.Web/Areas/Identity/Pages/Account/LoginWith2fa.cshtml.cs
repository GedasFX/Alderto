...
namespace Alderto.Web.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            var authenticatorCode = Input.TwoFactorCode.Replace(oldValue: " ", string.Empty).Replace(oldValue: "-", string.Empty);
            ...
            else
            {
                ...
                ModelState.AddModelError(string.Empty, errorMessage: "Invalid authenticator code.");
                return Page();
            }
        }  
    }
